...
export function GalleryFilter() {
  ...
  return (
    <div className="mb-6">
      <Button variant="outline" className="flex items-center gap-2 border-rose-200" onClick={() => setIsOpen(!isOpen)}>
        ...
        <Card className="mt-2 border-rose-200">
          <CardContent className="pt-4">
            ...
            <div className="mt-4 flex justify-end">
              <Button className="bg-rose-500 hover:bg-rose-600" onClick={applyFilters}>
                Apply Filters
              </Button>
            </div>
          </CardContent>
