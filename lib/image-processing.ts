  ...
  try {
    ...
    if (type === "human") {
      ...
      const promptMap = {
        ...
        GOTHIC: ORIGINAL_IMAGE_PROMPT_GOTHIC,
...
export async function createOppositeVersion(
  ...
  try {
    ...
    const humanToAnimalPrompts = {
      ...
      GOTHIC: HUMAN_TO_ANIMAL_PROMPT_GOTHIC,
    ...
    const animalToHumanPrompts = {
      ...
      GOTHIC: ANIMAL_TO_HUMAN_PROMPT_GOTHIC,
